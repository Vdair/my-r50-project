...
// 读取环境变量（支持小程序和 H5 环境）
const COZE_API_URL =
  (typeof process !== 'undefined' && process.env?.TARO_APP_COZE_API_URL) ||
  (typeof import.meta !== 'undefined' && import.meta.env?.TARO_APP_COZE_API_URL) ||
  ''

const COZE_API_TOKEN =
  (typeof process !== 'undefined' && process.env?.TARO_APP_COZE_API_TOKEN) ||
  (typeof import.meta !== 'undefined' && import.meta.env?.TARO_APP_COZE_API_TOKEN) ||
  ''
